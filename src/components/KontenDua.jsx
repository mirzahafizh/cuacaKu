  ...
  return (
    <div className="flex">
      <div className="w-[420px] h-[400px] relative mt-[20px] shadow-xl ml-[80px]">
        <div
          className={`w-[420px] h-[400px] left-0 top-[16px] absolute rounded-[30px] shadow-xl shadow-black ${
            darkMode ? 'bg-neutral-600 text-white' : 'bg-zinc-400 text-black'
          }`}
        />
        <div className="w-[420px] h-[400px] left-0 top-0 absolute flex flex-col justify-between">
          <div
            className={`w-72 h-[50px] left-[63px] top-[18px]  absolute text-center text-[32px] font-bold font-['Poppins'] mt-2 ${
            ...
            {currentWeather &&
              currentWeather.dummy5DaysForecast.map((forecast, index) => (
                ...
                >
                  ...
                  />
                  <div
                    className={`w-[62px] text-center  text-2xl font-semibold font-['Poppins']  ${
                      darkMode ? ' text-white ' : ' text-black'
                    }`}
                  >
                  ...
                  <div
                    className={`w-[163px] text-xl ml-[30px] font-semibold font-['Poppins']${
                      darkMode ? ' text-white ' : ' text-black'
                    }`}
                  >
                    {forecast.date}
      ...
      <div
        className={`w-[870px] h-[400px] relative rounded-[30px] shadow-xl shadow-black ml-[50px] mt-[40px] flex items-center  ${
          darkMode ? ' bg-neutral-600 text-white' : ' bg-zinc-400 text-black'
        }`}
      >
        ...
        <div className="flex justify-center items-center ml-[75px]">
          {currentWeather &&
            currentWeather.hourlyForecastData.map((data, index) => (
              ...
              >
                <div
                  className={`w-[130px] h-[270px] left-0 top-0 absolute rounded-[40px] shadow-xl shadow-black border-1 border-neutral  ${
                    darkMode ? ' bg-neutral-500 ' : ' bg-zinc-300'
                  }`}
                />
